  ...
  return (
    <div>
      ...
      <div className="page-sub">
        Manage all book listings on the marketplace
      </div>
          ...
          <tbody>
            {filtered.map((b) => (
              ...
              >
                ...
                <td className="px-4 py-3 text-sm text-slate-200 max-w-[180px] truncate font-medium">
                  {b.title}
                </td>
                ...
                <td className="px-4 py-3 whitespace-nowrap">
                  {b.status === "Pending Review" && (
                    <button
                      ...
                      onClick={() => toast(`${b.title} approved and listed!`)}
                    >
                      Approve
                    </button>
                  )}
                  <button
                    ...
                    onClick={() => toast(`${b.title} featured on homepage!`)}
                  >
                    Feature
                  </button>
                  <button
                    className="btn-danger"
                    onClick={() => toast(`${b.title} removed from listings`)}
                  >
                    Remove
                  </button>
                </td>
