...
import { reviewsService } from "../services/firestoreService";
  ...
  return (
    <div>
      ...
      <div className="page-sub">
        Review, approve, and moderate user-submitted reviews
      </div>
          ...
          <tbody>
            {reviews.map((r) => (
              ...
              >
                ...
                <td className="px-4 py-3 text-amber-400 text-sm tracking-tight">
                  {stars(r.rating)}
                </td>
                ...
                <td className="px-4 py-3 whitespace-nowrap">
                  {r.status !== "Approved" && (
                    <button
                      ...
                      onClick={() =>
                        updateStatus(r.id, "Approved", "Review approved!")
                      }
                    >
                      Approve
                    </button>
